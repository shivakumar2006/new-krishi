  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center gap-8">
      ...
      <div className="w-full flex flex-row justify-center items-center gap-5">
        <button className="w-100 h-15 text-white font-bold text-3xl cursor-pointer hover:bg-green-600 transition-colors duration-300 bg-green-500 rounded-3xl flex justify-center items-center">
          Farmer to users
        </button>
